# ordenacaonotas_insertionsort_python_LPIII
Código para organização de notas de alunos com a utilização de Insertion Sort como método de ordenação, e Tkinter como interface gráfica. 
